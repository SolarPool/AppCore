...
namespace Ciphernote.Net
{
    public class RestClient
    {
        ...
        public async Task<RestResponse<string>> ExecuteGetStringAsync(RestRequest request, CancellationToken? ct = null)
        {
            ...
            var httpResponse = await ExecuteInternal(request, ct);
            var content = await httpResponse.Content.ReadAsStringAsync();
            return new RestResponse<string>(httpResponse.StatusCode, httpResponse.IsSuccessStatusCode, content, content, httpResponse.Headers);
        }
        ...
        public async Task<RestResponse<byte[]>> ExecuteGetBytesAsync(RestRequest request, CancellationToken? ct = null)
        {
            ...
            return new RestResponse<byte[]>(httpResponse.StatusCode, httpResponse.IsSuccessStatusCode, content, Encoding.UTF8.GetString(content), httpResponse.Headers);
        }
